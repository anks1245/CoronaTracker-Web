...
<head>
    ...
    <title>covid19india(Daman and Diu)</title>
...
<header>
    ...
    <h1>Dadra and Nagar Haveli and Daman and Diu</h1>
    <?php foreach($coronadata2["Dadra and Nagar Haveli and Daman and Diu"]["districtData"] as $district => $data){ ?>
