...
$coronadata2=json_decode($data2,true);
    ...
    //echo "<pre>";
    //print_r($coronadata2["Andaman and Nicobar Islands"]);
    //echo "</pre>";

/*foreach($coronadata2["Andaman and Nicobar Islands"]["districtData"] as $district => $data){
    echo "{$district}<br>";
...
<head>
    ...
    <title>covid19india(Andaman and Nicobar)</title>
...
<header>
    ...
    <?php foreach($coronadata2["Andaman and Nicobar Islands"]["districtData"] as $district => $data){ ?>
